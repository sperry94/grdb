...
void cli_export_schemas(s_list_t s_list, FILE* out);
void cli_export_vertices(graph_t g, v_s_map_t vtx_maps, FILE* out);

v_s_map_t cli_export_collect_vtx_schemas(graph_t g, s_list_t s_list, int* s_id);
e_s_map_t cli_export_collect_edg_schemas(graph_t g, s_list_t s_list, int* s_id);
